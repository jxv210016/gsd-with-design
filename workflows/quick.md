...
If DESIGN_PATH is non-empty, it will be included in the planner and executor prompts below. If empty, the workflow behaves identically to before (vanilla behavior).
<!-- GSD-DESIGN-END -->
...
<!-- GSD-DESIGN-START -->
${DESIGN_PATH ? '- .planning/DESIGN.md (Design brief -- brand direction, emotional core, visual identity. Informational, never fail if missing.)' : ''}
<!-- GSD-DESIGN-END -->
</files_to_read>
...
<!-- GSD-DESIGN-START -->
${DESIGN_PATH ? '- .planning/DESIGN.md (Design brief -- reference for UI-related implementation decisions. Informational, never fail if missing.)' : ''}
<!-- GSD-DESIGN-END -->
</files_to_read>
